...
<section class="content">
    <div class="container-fluid">
        <a href="./articles/create" class="btn btn-primary"> <i class="fa-solid fa-circle-plus"></i>  Create Article</a>
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($articles as $article)
                                            <tr class="">
                                                <td style="vertical-align: middle;">{{$article->id}}</td>
                                                ...
                                                <td style="vertical-align: middle;text-align: center;">
                                                    <a href="./articles/edit/{{$article->id}}" class="btn btn-primary"> <i class="far fa-edit"></i></a>
