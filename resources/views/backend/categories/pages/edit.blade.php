                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="custom-content-below-tabContent">
                                    <div class="tab-pane fade show active" id="add-article-vi" role="tabpanel"
                                        ...
                                        <form   action="{{route('editTag',$tag->id)}}"  method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group form-group-addpro">
                                                ...
                                                <select class="form-select form-control status" name="status" id="inputProductType">
                                                    <option id="stsshow" value="1"
                                                        @if ($tag->status == 1) selected @endif>Actived
                                                    </option>
                                                    <option id="stshiden" value="0"
                                                        @if ($tag->status == 0) selected @endif>Disable
                                                    </option>
                                                </select>
                                            </div>
                                            <div style="text-align: center; padding-bottom: 2%">
                                                <input type="submit" name="submit" value="Edit Tag" class="btn btn-info px-5">
                                            </div>
                                        </form>
                                    </div>
                                </div>
