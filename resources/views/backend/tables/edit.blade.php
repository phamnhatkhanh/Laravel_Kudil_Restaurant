                                    ...
                                    <div class="tab-pane fade show active" id="add-article-vi" role="tabpanel"
                                        ...
                                        <form   action="{{route('editTable',$table->id)}}"  method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group form-group-addpro">
                                                ...
                                                <input type="number"  name="number_people" min="1" max="20" class="form-control" value = "{{$table->number_people}}">
                                            </div>
                                            <div class="form-group form-group-addpro">
                                                <label>Status</label>
                                            ...
                                            <div style="text-align: center; padding-bottom: 2%">
                                                <input type="submit" name="submit" value="Create Table" class="btn btn-info px-5">
                                            </div>
                                        </form>
                                    </div>
                                </div>
